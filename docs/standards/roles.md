...
## 1. Назначение
Документ фиксирует роли, владельцев и зоны ответственности в проекте `mango-tz-ai-analyzer`. Используется как единая точка ссылок на роли в концепции, ADR и аналитических документах.
