# 📦 Бэклог оптимизации RAG-пайплайна (P0–P2) — v1.3
...
- **Дата:** 2026-05-19
- **Версия:** v1.3
- **Предыдущая версия:** [`docs/backlog/2026-05-17_backlog_rag-optimization_v1.2.md`](2026-05-17_backlog_rag-optimization_v1.2.md).
...
- **Связанные документы:**
  ...
  - [`docs/standards/naming-convention.md`](../standards/naming-convention.md) v1.1 — стандарт именования (тип `backlog`, версия `v1.3`).
...
| ID | Задача | GitHub Issue | Статус | Примечание |
|----|--------|--------------|--------|------------|
| BL-01 | HybridRetriever | [#91](https://github.com/G-Ivan-A/clarify-engine-ai/issues/91) | ✅ Closed | 2 days ago |
| BL-05 | Golden Set Runner | [#105](https://github.com/G-Ivan-A/clarify-engine-ai/issues/105) | ✅ Closed | yesterday |
| BL-06 | Chunker L1 | [#92](https://github.com/G-Ivan-A/clarify-engine-ai/issues/92) | ✅ Closed | 2 days ago |
| BL-07 | UI modes | [#93](https://github.com/G-Ivan-A/clarify-engine-ai/issues/93) | ✅ Closed | 2 days ago |
| BL-08 | Prompt Library | [#94](https://github.com/G-Ivan-A/clarify-engine-ai/issues/94) | ✅ Closed | 2 days ago |
| BL-13 | Graceful Degradation | [#106](https://github.com/G-Ivan-A/clarify-engine-ai/issues/106) | ✅ Closed | yesterday |
| BL-15 | Context export | [#107](https://github.com/G-Ivan-A/clarify-engine-ai/issues/107) | ✅ Closed | 2 days ago |
| BL-18 | DocxParser integration | [#132](https://github.com/G-Ivan-A/clarify-engine-ai/issues/132) | ✅ Closed | 1 hour ago |
| BL-22 | Decoding Config | [#101](https://github.com/G-Ivan-A/clarify-engine-ai/issues/101) | ✅ Closed | 2 days ago |
| BL-23 | Tracing (run_id) | [#103](https://github.com/G-Ivan-A/clarify-engine-ai/issues/103) | ✅ Closed | yesterday |
| BL-24a | torchvision | [#120](https://github.com/G-Ivan-A/clarify-engine-ai/issues/120) | ✅ Closed | 2 hours ago |
| BL-24b | UI diagnostics | [#121](https://github.com/G-Ivan-A/clarify-engine-ai/issues/121) | ✅ Closed | 2 hours ago |
| BL-25 | Ollama config | [#122](https://github.com/G-Ivan-A/clarify-engine-ai/issues/122) | ✅ Closed | 1 hour ago |
| BL-26 | Code Review fixes | [#142](https://github.com/G-Ivan-A/clarify-engine-ai/issues/142) | 🏃 **In Progress** | В работе (PO) |
...
`docs/backlog/2026-05-17_backlog_rag-optimization_v1.3.md` (см.
...
naming-convention.md); MINOR-версия `v1.3` отражает уточнения по
...
## 9. ✅ Критерии приёмки (Definition of Done) — v1.3

- [ ] Файл `docs/backlog/2026-05-17_backlog_rag-optimization_v1.3.md` создан и соответствует [`naming-convention.md`](../standards/naming-convention.md) v1.1 (тип `backlog`, MINOR-версия `v1.3`).
